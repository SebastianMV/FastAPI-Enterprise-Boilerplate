...
async def main():
    ...
    print("=" * 60)
    conn_owner = await asyncpg.connect('postgresql://boilerplate:boilerplate@localhost:5432/boilerplate')
    ...
    await conn_owner.execute("SET LOCAL app.current_tenant_id = '00000000-0000-0000-0000-000000000001';")
    ...
    print("=" * 60)
    conn_app = await asyncpg.connect('postgresql://app_user:app_password@localhost:5432/boilerplate')
    ...
    await conn_app.execute("SET LOCAL app.current_tenant_id = '00000000-0000-0000-0000-000000000001';")
    users = await conn_app.fetch("SELECT COUNT(*) as count FROM users WHERE tenant_id::text = '00000000-0000-0000-0000-000000000001';")
