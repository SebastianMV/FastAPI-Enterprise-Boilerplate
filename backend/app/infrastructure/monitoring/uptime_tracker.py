...
class UptimeTracker:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            logger.warning(f"Failed to initialize uptime tracker in Redis: {e}")
    ...
    async def record_ping(self, is_healthy: bool) -> None:
        ...
        try:
            ...
            logger.warning(f"Failed to record ping in Redis: {e}")
    ...
    async def get_uptime_percentage(self) -> float:
        ...
        try:
            ...
            logger.warning(f"Failed to get uptime percentage: {e}")
    ...
    async def get_uptime_duration(self) -> timedelta:
        ...
        try:
            ...
            logger.warning(f"Failed to get uptime duration: {e}")
    ...
    async def get_last_ping(self) -> datetime | None:
        ...
        try:
            ...
            logger.warning(f"Failed to get last ping: {e}")
    ...
    async def get_recent_incidents(self, limit: int = 10) -> list[dict[str, Any]]:
        ...
        try:
            ...
            return [eval(incident) for incident in incidents]
            
        except Exception as e:
            logger.warning(f"Failed to get recent incidents: {e}")
            return []
