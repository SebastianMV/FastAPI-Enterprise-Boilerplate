...
from app.domain.ports.websocket import ConnectionInfo, WebSocketMessage, MessageType
...
class TestSendToRoomEdgeCases:
    ...
    async def test_send_to_room_excludes_connection(
        ...
        message = WebSocketMessage(type=MessageType.BROADCAST, payload={"event": "start"})
...
class TestProcessMessageErrorHandling:
    ...
    async def test_message_handler_exception_handling(
        ...
        message = WebSocketMessage(type=MessageType.NOTIFICATION, payload={"test": "data"})
