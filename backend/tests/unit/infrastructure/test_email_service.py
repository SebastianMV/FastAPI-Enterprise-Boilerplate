...
class TestEmailBackend:
    ...
    def test_backend_values(self) -> None:
        ...
        assert EmailBackend.SENDGRID.value == "sendgrid"
        assert EmailBackend.AWS_SES.value == "aws_ses"
        assert EmailBackend.MAILGUN.value == "mailgun"
    ...
    def test_all_backends_exist(self) -> None:
        ...
        expected = {"console", "smtp", "sendgrid", "aws_ses", "mailgun"}
...
class TestEmailService:
    ...
    def test_init_with_defaults(self) -> None:
        ...
        from app.infrastructure.email.service import EmailService, ConsoleEmailSender
        
        with patch("app.infrastructure.email.service.get_template_engine") as mock_engine:
