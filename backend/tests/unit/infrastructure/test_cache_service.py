...
class TestCachedDecorator:
    ...
    async def test_cached_decorator_returns_cached_value(self):
        from app.infrastructure.cache.cache_service import cached, _cache_service, CacheService
        ...
        with patch("app.infrastructure.cache.cache_service.settings") as mock_settings:
            ...
            with patch("app.infrastructure.cache.cache_service.get_cache_service", 
...
class TestInvalidateCacheDecorator:
    ...
    async def test_invalidate_cache_decorator(self):
        from app.infrastructure.cache.cache_service import invalidate_cache, CacheService
