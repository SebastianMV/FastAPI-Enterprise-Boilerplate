...
try:
    from app.infrastructure.storage.s3 import S3StorageAdapter, HAS_BOTO3
except ImportError:
    HAS_BOTO3 = False
...
class TestS3StorageAdapter:
    ...
    def mock_s3_client(self):
        ...
        client.generate_presigned_url = MagicMock(return_value="https://s3.amazonaws.com/bucket/file.txt?signature=xyz")
    ...
    async def test_get_presigned_url_for_download(self, adapter, mock_s3_client):
        ...
        mock_s3_client.generate_presigned_url.return_value = "https://s3.amazonaws.com/signed"
