...
class TestNotificationServiceConvenienceMethods:
    ...
    @pytest.mark.asyncio
    async def test_notify_login_alert_with_location(self, mock_session, mock_ws_manager):
...
class TestNotificationServiceDelivery:
    ...
    @pytest.mark.asyncio
    async def test_deliver_via_websocket_no_connections(self, mock_session, mock_ws_manager):
