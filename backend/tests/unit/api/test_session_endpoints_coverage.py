...
class TestGetCurrentTokenJti:
    ...
    def test_get_current_token_jti_invalid_token(self):
        ...
        with patch('app.api.v1.endpoints.sessions.validate_access_token') as mock_validate:
...
class TestRevokeSessionEndpoint:
    ...
    async def test_revoke_session_success(self, mock_sessions):
        ...
        with patch(
            ...
            with patch('app.api.v1.endpoints.sessions.get_current_token_jti') as mock_get_jti:
