...
class TestHealthEndpoints:
    ...
    async def test_readiness_check_redis_healthy(self):
        ...
        with patch('app.infrastructure.monitoring.get_metrics_service', return_value=mock_metrics), \
             patch('app.infrastructure.monitoring.get_uptime_tracker', return_value=mock_uptime):
