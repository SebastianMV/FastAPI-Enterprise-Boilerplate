...
class TestCreateSuperuserAsync:
    ...
    async def test_create_superuser_invalid_email(self):
        ...
        with patch('app.cli.commands.users.console') as mock_console, \
    ...
    async def test_create_superuser_email_already_exists(self):
        ...
        with patch('app.infrastructure.database.connection.async_session_maker') as mock_maker, \
            ...
            await _create_superuser("existing@example.com", "SecureP@ss123!", "Admin", "User")
    ...
    async def test_create_superuser_success(self):
        ...
        with patch('app.infrastructure.database.connection.async_session_maker') as mock_maker, \
            ...
            await _create_superuser("newadmin@example.com", "SecureP@ss123!", "Admin", "User")
        
        mock_user_repo.create.assert_called_once()
        mock_session.commit.assert_called_once()
        assert "Superuser created successfully" in str(mock_console.print.call_args_list)
