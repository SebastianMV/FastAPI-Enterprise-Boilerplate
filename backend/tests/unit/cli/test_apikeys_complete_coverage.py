...
class TestCreateAPIKeyAsync:
    ...
    async def test_create_api_key_success_no_expiration(self):
        ...
        with patch('app.infrastructure.database.connection.async_session_maker') as mock_maker, \
             patch('app.infrastructure.database.repositories.user_repository.SQLAlchemyUserRepository', return_value=mock_user_repo), \
             patch('app.infrastructure.auth.jwt_handler.hash_password', return_value="hashed_key"), \
             patch('app.infrastructure.database.models.api_key.APIKeyModel', return_value=mock_api_key_model), \
    ...
    async def test_create_api_key_with_expiration(self):
        ...
        with patch('app.infrastructure.database.connection.async_session_maker') as mock_maker, \
             ...
             patch('app.infrastructure.database.models.api_key.APIKeyModel', mock_api_key_class), \
             patch('app.cli.commands.apikeys.console'):
