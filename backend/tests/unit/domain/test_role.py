...
class TestRole:
    ...
    def test_has_any_permission(self):
        ...
        assert (
            role.has_any_permission([("users", "read"), ("settings", "read")]) is True
        )
        assert (
            role.has_any_permission([("settings", "read"), ("logs", "read")]) is False
        )
    ...
    def test_has_all_permissions(self):
        ...
        assert (
            role.has_all_permissions([("users", "read"), ("settings", "read")]) is False
        )
