...
down_revision: Union[str, None] = '006_rls_policies'
...
def upgrade() -> None:
    ...
    op.add_column('tenants', sa.Column('is_verified', sa.Boolean, nullable=False, server_default='false'))
    ...
    op.add_column('tenants', sa.Column('timezone', sa.String(50), nullable=False, server_default="'UTC'"))
    op.add_column('tenants', sa.Column('locale', sa.String(10), nullable=False, server_default="'en'"))
    ...
    # Audit column
    op.add_column('api_keys', sa.Column('created_by', UUID(as_uuid=True), nullable=True))
