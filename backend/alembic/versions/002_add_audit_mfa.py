...
def upgrade() -> None:
    ...
    op.create_index('ix_audit_logs_tenant_activity', 'audit_logs', 
                    ['tenant_id', 'timestamp'])
    op.create_index('ix_audit_logs_security', 'audit_logs', 
                    ['action', 'timestamp'])
    op.create_index('ix_audit_logs_actor_activity', 'audit_logs', 
                    ['actor_id', 'timestamp'])
    ...
    op.create_table(
        ...
        sa.Column('backup_codes', postgresql.ARRAY(sa.String(64)), 
