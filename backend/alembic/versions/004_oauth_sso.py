...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("scopes", postgresql.ARRAY(sa.String), nullable=True),
        sa.Column(
            "attribute_mapping", postgresql.JSONB, nullable=True, server_default="{}"
        ),
        sa.Column(
            "auto_create_users", sa.Boolean, nullable=False, server_default="true"
        ),
        sa.Column(
            "auto_update_users", sa.Boolean, nullable=False, server_default="true"
        ),
