...
down_revision: Union[str, None] = '010_add_avatar_url'
...
def upgrade() -> None:
    ...
    op.execute("DROP POLICY IF EXISTS conversation_participants_tenant_isolation ON conversation_participants")
    
    # Drop indexes
    op.drop_index('ix_chat_messages_tenant_id', table_name='chat_messages', if_exists=True)
    ...
    op.drop_index('ix_chat_messages_conv_created', table_name='chat_messages', if_exists=True)
    op.drop_index('ix_chat_messages_is_deleted', table_name='chat_messages', if_exists=True)
    
    op.drop_index('ix_conv_participants_user_id', table_name='conversation_participants', if_exists=True)
    op.drop_index('ix_conv_participants_conv_user', table_name='conversation_participants', if_exists=True)
    ...
    op.drop_index('ix_conversations_is_deleted', table_name='conversations', if_exists=True)
...
def downgrade() -> None:
    ...
    op.create_index('ix_conv_participants_conv_user', 'conversation_participants', 
    ...
    op.create_index('ix_chat_messages_conv_created', 'chat_messages', 
