...
(out_dir / "AUDIT40_ISSUES_TABLE_FULL.md").write_text(
    "# Audit N°40 - Tabla Completa de Issues\n\n"
...
(out_dir / "AUDIT40_ISSUES_TABLE_SUMMARY.md").write_text(
    "# Audit N°40 - Resumen por Severidad\n\n"
...
(out_dir / "AUDIT40_ISSUES_TABLE_BY_RULE.md").write_text(
