...
describe('DashboardPage', () => {
  ...
  it('should render recent activity', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('User john@test.com registered')).toBeInTheDocument();
    });
  });
  ...
  it('should render quick actions', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getAllByText('dashboard.apiKeys').length).toBeGreaterThanOrEqual(1);
  ...
  it('should render user overview stats', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('dashboard.newUsersLast7Days')).toBeInTheDocument();
    });
  });
});
